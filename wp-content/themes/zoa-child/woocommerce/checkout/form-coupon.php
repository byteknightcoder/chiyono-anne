...
<div class="coupon_below_total">
  <div class="woocommerce-form-coupon-toggle">
    <?php wc_print_notice( apply_filters( 'woocommerce_checkout_coupon_message',' <a href="#" class="showcoupon">' . esc_html__('Click here to enter your code', 'zoa') . '</a>'), 'notice'); ?>
  </div>
  <div id="couponBox" class="order--checkout__col--summary summary col-xs-12 toggle--active">
