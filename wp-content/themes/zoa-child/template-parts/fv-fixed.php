...
$alt = $fvimg['alt'] ? $fvimg['alt'] : $title;
					...
					?>
                                                     <?php
                                                    if(isset($photo_meta)&&!empty($photo_meta['photography'])&&!empty($photo_meta['styling'])){
                                                    ?>
							<div class="end_header">
								<div class="end_credit">
									<span class="credit">Photography <?php echo trim($photo_meta['photography']); ?></span><span class="credit">Styling <?php echo trim($photo_meta['styling']); ?></span>
								</div>
							</div>
                                                    <?php } ?>
							<?php zoa_seo_data(); ?>
