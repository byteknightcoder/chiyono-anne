...
function zoa_template_loop_product_title() {
    echo '<h2 class="woocommerce-loop-product__title"><a href="' . get_permalink() . '">' . (function_exists('get_the_title_product_chiyono') ? get_the_title_product_chiyono() : get_the_title() )  . '</a></h2>';
}
