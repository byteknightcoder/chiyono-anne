 ...
 * @since 1.0.0
 */
class Zoa_Quote_JA extends Widget_Base {
    ...
    public function get_title() {
        return esc_html__('JA quote for blog', 'zoa');
    }
    ...
    protected function _register_controls() {
        $this->start_controls_section(
                'section_quote_ja', [
            'label' => esc_html__('JA quote for blog', 'zoa'),
                ]
        );
        $this->add_control(
                'title_align', array(
        ...
        <div class="para__center bsec">
            <blockquote class="pull-quote">
                <div class="qupte_wrap o quote-before">“</div><div class="quote_inner">
                    <h5 class="em_title e <?php echo $title_align; ?>"><em><?php echo $settings['quote']; ?></em></h5>
...
Plugin::instance()->widgets_manager->register_widget_type(new Zoa_Quote_JA());
