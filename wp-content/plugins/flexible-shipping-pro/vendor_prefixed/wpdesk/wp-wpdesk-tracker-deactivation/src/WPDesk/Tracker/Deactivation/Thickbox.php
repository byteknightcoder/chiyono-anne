...
class Thickbox
{
     ...
     */
    public function __construct(\FSProVendor\WPDesk\Tracker\Deactivation\PluginData $plugin_data, \FSProVendor\WPDesk\Tracker\Deactivation\ReasonsFactory $reasons_factory, $view_file = null)
    {
