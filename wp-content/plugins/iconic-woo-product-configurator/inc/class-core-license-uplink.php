...
if ( class_exists( 'Iconic_PC_Core_License_Uplink' ) ) {
	return;
}

use Iconic_PC_NS\StellarWP\Uplink\Admin\License_Field;
use Iconic_PC_NS\StellarWP\Uplink\Config;
use Iconic_PC_NS\StellarWP\Uplink\Uplink;
use Iconic_PC_NS\StellarWP\Uplink\Register;

/**
 * Iconic_PC_Core_License_Uplink.
 *
 * @class    Iconic_PC_Core_License_Uplink
 * @version  1.0.0
 */
class Iconic_PC_Core_License_Uplink {
	/**
	 * Single instance of the Iconic_PC_Core_License_Uplink object.
	 *
	 * @var Iconic_PC_Core_License_Uplink|null
	 */
	...
	/**
	 * Creates/returns the single instance Iconic_PC_Core_License_Uplink object.
	 *
	 * @param array $args Arguments.
	 *
	 * @return Iconic_PC_Core_License_Uplink
	 */
	...
	public static function dequeue_scripts_and_styles() {
		...
		if ( ! Iconic_PC_Core_Settings::is_settings_page() ) {
			return;
		}
	...
	public static function add_action_links( $links ) {
		$links[] = sprintf( '<a href="%s" target="_blank">%s</a>', esc_url( self::$args['urls']['product'] ) . '/changelog/?utm_source=Iconic&utm_medium=Plugin&utm_campaign=changelog-link&utm_content=jckpc', __( 'Changelog', 'jckpc' ) );
