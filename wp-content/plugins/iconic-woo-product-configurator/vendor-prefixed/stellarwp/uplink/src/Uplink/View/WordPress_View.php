...
namespace Iconic_PC_NS\StellarWP\Uplink\View;

use Iconic_PC_NS\StellarWP\Uplink\View\Exceptions\FileNotFoundException;
	...
	private function get_path( string $name ): string {
		...
		if( $path === false ) {
			throw new FileNotFoundException(
				sprintf( __( 'View file "%s" not found or not readable.', 'jckpc' ), $file )
			);
		}
