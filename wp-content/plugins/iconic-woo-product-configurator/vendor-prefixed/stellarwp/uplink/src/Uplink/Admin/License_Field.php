...
namespace Iconic_PC_NS\StellarWP\Uplink\Admin;

use Iconic_PC_NS\StellarWP\Uplink\Config;
use Iconic_PC_NS\StellarWP\Uplink\Resources\Plugin;
use Iconic_PC_NS\StellarWP\Uplink\Resources\Resource;
use Iconic_PC_NS\StellarWP\Uplink\Resources\Service;
...
class License_Field extends Field {
		...
		foreach ( $this->get_resources() as $resource ) {
			...
			add_settings_field(
				...
				[
					...
					'placeholder'  => __( 'License Number', 'jckpc' ),
	...
	public function get_field_html( $plugin ) : string {
		$html = sprintf( '<p class="tooltip description">%s</p>', __( 'A valid license key is required for support and updates', 'jckpc' ) );
