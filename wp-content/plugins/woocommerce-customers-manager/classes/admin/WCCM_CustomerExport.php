...
class WCCM_CustomerExport {
    ...
    public function process_export_csv_chunk() { //Registerd customers
        ...
        foreach ($customers as $customer) {
            ...
            $phone = isset($customer_extra_info['digits_phone']) ? $customer_extra_info['digits_phone'][0] : '';
            ...
            if (!empty($billing_country)) {
                $billing_state = WC()->countries->get_states($billing_country);
                $temp_bs = isset($customer_extra_info['billing_state']) ? str_replace($bad_chars, '', $customer_extra_info['billing_state'][0]) : '';
                if (!empty($temp_bs)) {
                    $billing_state = trim($billing_state[$temp_bs]);
                } else {
                    $billing_state = '';
                }
            } else {
            ...
            if (!empty($shipping_country)) {
                $shipping_state = WC()->countries->get_states($shipping_country);
                $temp_bs = isset($customer_extra_info['shipping_state']) ? str_replace($bad_chars, '', $customer_extra_info['shipping_state'][0]) : '';
                if (!empty($temp_bs)) {
                    $shipping_state = trim($shipping_state[$temp_bs]);
                } else {
                    $shipping_state = '';
                }
            } else {
            ...
            //birthday
            if (isset($customer_extra_info['account_birth'][0]) && !empty($customer_extra_info['account_birth'][0])) {
                $account_birth = unserialize($customer_extra_info['account_birth'][0]);
            ...
            $temp_user_data = array('ID' => $customer->ID,
                ...
                'billing_state' => str_replace($bad_chars, '', $billing_state),
                'billing_country' => isset($customer_extra_info['billing_country']) ? str_replace($bad_chars, '', $customer_extra_info['billing_country'][0]) : '',
                ...
                'shipping_state' => str_replace($bad_chars, '', $shipping_state),
                'shipping_country' => isset($customer_extra_info['shipping_country']) ? str_replace($bad_chars, '', $customer_extra_info['shipping_country'][0]) : '',
                'billing_last_name_kana' => isset($customer_extra_info['billing_last_name_kana']) ? str_replace($bad_chars, '', $customer_extra_info['billing_last_name_kana'][0]) : '',
                'billing_first_name_kana' => isset($customer_extra_info['billing_first_name_kana']) ? str_replace($bad_chars, '', $customer_extra_info['billing_first_name_kana'][0]) : '',
                'shipping_last_name_kana' => isset($customer_extra_info['shipping_last_name_kana']) ? str_replace($bad_chars, '', $customer_extra_info['shipping_last_name_kana'][0]) : '',
                'shipping_first_name_kana' => isset($customer_extra_info['shipping_first_name_kana']) ? str_replace($bad_chars, '', $customer_extra_info['shipping_first_name_kana'][0]) : '',
                'birthday' => '"' . $account_birth . '"',
                'phone' => '"' . $phone . '"',
            );
    ...
    public function render_page() {
        ...
        <script>
            ...
            var wpuef_addition_columns = [<?php
