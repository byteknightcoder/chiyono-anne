...
<p><?php esc_html_e('When do you want to send out appointment reminders 2st time?', 'booked'); ?></p>
                                            ...
                                            <div class="section-row">
                                                <div class="section-head">
                                                    ...
                                                    $option_name_try_fit = 'booked_reminder_email_try_fit_your_size';
                                                    $option_name_special = 'booked_reminder_email_special';
...
Your friends at ' . get_bloginfo('name');
                                                    ...
                                                    $email_content_admin_reminder_try_fit = get_option($option_name_try_fit, $default_content);
                                                    $email_content_admin_reminder_special = get_option($option_name_special, $default_content);
                    ...
                    <?php wp_editor($email_content_admin_reminder, $option_name, array('textarea_name' => $option_name, 'media_buttons' => false, 'editor_height' => 250, 'teeny' => true)); ?>
                                                    <hr/>
                                                    <strong>For appointment Reminder of Try fit your size.</strong>
                                                    <?php wp_editor($email_content_admin_reminder_try_fit, $option_name_try_fit, array('textarea_name' => $option_name_try_fit, 'media_buttons' => false, 'editor_height' => 250, 'teeny' => true)); ?>
                                                    <hr/>
<strong>For appointment Reminder of Special Appointment.</strong>
                                                    <?php wp_editor($email_content_admin_reminder_special, $option_name_special, array('textarea_name' => $option_name_special, 'media_buttons' => false, 'editor_height' => 250, 'teeny' => true)); ?>
<?php
$option_name_bes_off='booked_bspkmonth_offline_reminder';
$email_content_admin_reminder_bes_off = get_option($option_name_bes_off, $default_content);
?>
<hr/>
<strong>Atelier Consultation of Bespoke Month</strong>
                                                    <?php wp_editor($email_content_admin_reminder_bes_off, $option_name_bes_off, array('textarea_name' => $option_name_bes_off, 'media_buttons' => false, 'editor_height' => 250, 'teeny' => true)); ?>

<?php
$option_name_bes_off='booked_bspkmonth_online_reminder';
$email_content_admin_reminder_bes_off = get_option($option_name_bes_off, $default_content);
?>
<hr/>
<strong>Online Consultation  of Bespoke Month</strong>
                                                    <?php wp_editor($email_content_admin_reminder_bes_off, $option_name_bes_off, array('textarea_name' => $option_name_bes_off, 'media_buttons' => false, 'editor_height' => 250, 'teeny' => true)); ?>
                                                </div>
                                            </div><!-- /.section-row -->
...
Your friends at ' . get_bloginfo('name');
                                            ...
                                            <div class="section-row" data-controller="cp_fes_controller" data-controlled_by="fes_enabled">
                                                <div class="section-head">
                                                    ...
                                                    $option_name_try_fit = 'booked_appt_confirmation_email_content_try_fit_your_size';
                                                    $option_name_special = 'booked_appt_confirmation_email_content_special';
...
Your friends at ' . get_bloginfo('name');
                                                    ...
                                                    $email_content_approval_try_fit = get_option($option_name_try_fit, $default_content);
                                                    $email_content_approval_special = get_option($option_name_special, $default_content);
                                                    ...
                                                    <hr/>
                                                    <strong>For appointment Confirmation of Try fit your size.</strong>
                                                    <?php wp_editor($email_content_approval_try_fit, $option_name_try_fit, array('textarea_name' => $option_name_try_fit, 'media_buttons' => false, 'editor_height' => 350, 'teeny' => true)); ?>
                                                    <hr/>
                                                    <strong>For appointment Confirmation of Special Appointment.</strong>
                                                    <?php wp_editor($email_content_approval_special, $option_name_special, array('textarea_name' => $option_name_special, 'media_buttons' => false, 'editor_height' => 350, 'teeny' => true)); ?>
                                                    <?php
$option_name_bes_off='booked_bspkmonth_offline_confirmation';
$email_content_admin_reminder_bes_off = get_option($option_name_bes_off, $default_content);
?>
                                                    <hr/>
<strong>Atelier Consultation of Bespoke Month</strong>
...
<?php
$option_name_bes_off='booked_bspkmonth_online_confirmation';
$email_content_admin_reminder_bes_off = get_option($option_name_bes_off, $default_content);
?>
<hr/>
<strong>Online Consultation  of Bespoke Month</strong>
                                            ...
                                            <div class="section-row" data-controller="cp_fes_controller" data-controlled_by="fes_enabled">
                                                <div class="section-head">
                                                    ...
                                                    $option_name_approval_try = 'booked_approval_email_content_try_fit';
                                                    $option_name_approval_special = 'booked_approval_email_content_special';
...
Your friends at ' . get_bloginfo('name');
                                                    ...
                                                    $email_content_approval = get_option($option_name, $default_content);
                                                    $email_content_bookapproval_try_fit = get_option($option_name_approval_try, $default_content);
                                                    $email_content_bookapproval_special = get_option($option_name_approval_special, $default_content);
                                                    ...
                                                    <input style="margin:0" name="<?php echo $subject_var; ?>" value="<?php echo $current_subject_value; ?>" type="text" class="field">
                                                        <?php wp_editor($email_content_approval, $option_name, array('textarea_name' => $option_name, 'media_buttons' => false, 'editor_height' => 350, 'teeny' => true)); ?>
                                                    <hr/>
                                                    <strong>For appointment approval of Try fit your size.</strong>
                                                    <?php wp_editor($email_content_bookapproval_try_fit, $option_name_approval_try, array('textarea_name' => $option_name_approval_try, 'media_buttons' => false, 'editor_height' => 350, 'teeny' => true)); ?>
                                                    <hr/>
<strong>For appointment approval of Special Appointment.</strong>
                                                    <?php wp_editor($email_content_bookapproval_special, $option_name_approval_special, array('textarea_name' => $option_name_approval_special, 'media_buttons' => false, 'editor_height' => 350, 'teeny' => true)); ?>
                                                    <?php
$option_name_bes_off='booked_bspkmonth_offline_approval';
$email_content_admin_reminder_bes_off = get_option($option_name_bes_off, $default_content);
?>
<hr/>
<strong>Atelier Consultation of Bespoke Month</strong>
...
<?php
$option_name_bes_off='booked_bspkmonth_online_approval';
$email_content_admin_reminder_bes_off = get_option($option_name_bes_off, $default_content);
?>
<hr/>
<strong>Online Consultation  of Bespoke Month</strong>
                                            ...
                                            <div class="section-row" data-controller="cp_fes_controller" data-controlled_by="fes_enabled">
                                                <div class="section-head">
                                                    ...
                                                    $option_name_try_fit = 'booked_cancellation_email_content_try_fit_your_size';
$option_name_special = 'booked_cancellation_email_content_special';
                                                    $default_content = 'Hey %name%!
...
Your friends at ' . get_bloginfo('name');
                    ...
                    ?>
                                                    ...
                                                    <?php wp_editor($email_content_approval, $option_name, array('textarea_name' => $option_name, 'media_buttons' => false, 'editor_height' => 350, 'teeny' => true)); ?>
                                                    <hr/>
<strong>For appointment Cancellation of Try fit your size.</strong>
                                                    <?php wp_editor($email_content_approval_try_fit, $option_name_try_fit, array('textarea_name' => $option_name_try_fit, 'media_buttons' => false, 'editor_height' => 350, 'teeny' => true)); ?>
<hr/>
<strong>For appointment Cancellation of Special Appointment.</strong>
                                                    <?php wp_editor($email_content_approval_special, $option_name_special, array('textarea_name' => $option_name_special, 'media_buttons' => false, 'editor_height' => 350, 'teeny' => true)); ?>
                                                    <?php
$option_name_bes_off='booked_bspkmonth_offline_cancellation';
$email_content_admin_reminder_bes_off = get_option($option_name_bes_off, $default_content);
?>
<hr/>
<strong>Atelier Consultation of Bespoke Month</strong>
...
<?php
$option_name_bes_off='booked_bspkmonth_online_cancellation';
$email_content_admin_reminder_bes_off = get_option($option_name_bes_off, $default_content);
?>
<hr/>
<strong>Online Consultation  of Bespoke Month</strong>
