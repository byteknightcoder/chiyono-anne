    ...
    if ($todays_defaults) {
        ...
        if (!empty($appointments_array)):
            ...
            foreach ($appointments_array as $appointment):
                ...
                $c_title= get_post_meta($appointment['post_id'], '_appointment_title', true);
                echo '<span class="timeslot-time">';
                if(!empty($c_title)){
                    echo '<span class="timeslot-title">'.$c_title.'</span><br/>';
                }
                echo date_i18n($time_format, strtotime($timeslot[0])) . ' &ndash; ' . date_i18n($time_format, strtotime($timeslot[1])) . '</span>';
