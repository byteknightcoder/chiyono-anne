...
class YAYDP_Checkout_Fee_Manager {
	...
	private function handle_encouraged_notice() {
		\YAYDP\Core\Encouraged_Notice\YAYDP_Checkout_Fee_Encouraged_Notice_Handler::get_instance();
	}
	...
	private function handle_countdown() {
		\YAYDP\Core\Countdown\YAYDP_Checkout_Fee_Countdown_Handler::get_instance();
	}
