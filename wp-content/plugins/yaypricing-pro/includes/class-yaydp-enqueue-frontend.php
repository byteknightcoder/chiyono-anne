...
class YAYDP_Enqueue_Frontend {
	...
	public function enqueue_scripts() {
		 ...
		 * Enqueue countdown
		 */
		$this->enqueue_script( 'countdown', 'countdown.js', array( 'jquery' ) );
		wp_localize_script(
			'yaydp-frontend-countdown',
			'yaydp_countdown_data',
			array(
				'timezone_string' => wp_timezone_string(),
			)
		);
		$this->enqueue_style( 'countdown', 'countdown.css' );
		...
		$this->enqueue_style( 'matching-products', 'matching-products.css' );

		/**
		 * Encouraged notice
		 */
		$this->enqueue_script( 'encouraged-notice', 'encouraged-notice.js' );
		$this->enqueue_style( 'encouraged-notice', 'encouraged-notice.css' );
