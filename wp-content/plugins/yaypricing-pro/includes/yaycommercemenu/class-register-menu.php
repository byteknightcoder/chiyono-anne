...
class Register_Menu {
	...
	public function get_submenus() {
		return array(
			// 'yaycommerce-dashboard'     => array(
			// 'parent'             => 'yaycommerce',
			// 'name'               => __( 'Dashboard', 'yaycommerce' ),
			// 'capability'         => 'manage_options',
			// 'render_callback'    => array( '\YAYDP\YayCommerceMenu\DashboardMenu', 'render' ),
			// 'load_data_callback' => array( '\YAYDP\YayCommerceMenu\DashboardMenu', 'load_data' ),
			// 'position'           => 0,
			// ),
			...
			'yaycommerce-licenses'      => array(
				...
				'capability'         => 'manage_options',
				'render_callback'    => array( '\YAYDP\YayCommerceMenu\Licenses_Menu', 'render' ),
				'load_data_callback' => array( '\YAYDP\YayCommerceMenu\Licenses_Menu', 'load_data' ),
			),
