...
$sale_text = apply_filters( 'yaydp_sale_tag_text', 'SALE!', empty( $matching_rules ) ? [] : $matching_rules );
$up_to_text = apply_filters( 'yaydp_sale_tag_up_to_text', 'Up to %s', empty( $matching_rules ) ? [] : $matching_rules );
