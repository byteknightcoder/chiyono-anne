...
class License {
	...
	public function activate( $license_key ) {
		$licensing_plugin  = new Licensing_Plugin( $this->slug );
		$item_id           = $licensing_plugin->get_option( 'item_id' );
		$activate_response = License_API::activate_license( $item_id, $license_key );
	...
	public function update() {
		...
		$response = License_API::check_license( $item_id, $license_key );
		if ( $response['success'] ) {
