<?php
	...
	use YAYDP\License\Licensing_Plugin;
	use YAYDP\License\Core_Plugin;
					...
					<div class="yaycommerce-license-settings">
						...
						foreach ( $licensing_plugins as $_plugin ) {
							...
							if ( $license->is_active() ) {
								require Core_Plugin::get( 'path' ) . 'views/license/information-card.php';
							} else {
								require Core_Plugin::get( 'path' ) . 'views/license/activate-card.php';
							}
						}
