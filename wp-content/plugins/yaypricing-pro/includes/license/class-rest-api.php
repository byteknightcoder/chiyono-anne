...
class Rest_API {
	...
	public function init_rest_api() {
		register_rest_route(
			Core_Plugin::get( 'slug' ) . '-license/v1',
			'/license/activate',
			array(
	...
	public function activate_license( $request_data ) {
		...
		$licensing_plugin         = new Licensing_Plugin( $plugin_slug );
		...
		if ( $activate_response['success'] ) {
			...
			$return_result['message'] = License_API::get_error_message( $activate_response['message'] );
		}
